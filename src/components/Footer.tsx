...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 mt-auto border-t border-white/10 bg-gradient-to-b from-white/5 to-white/10 backdrop-blur-xl">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/5 text-white transition-all hover:border-emerald-500/50 hover:bg-emerald-500/10 hover:text-emerald-400"
              >
